...
sap.ui.model.json.JSONModel.extend("onlineRetSelUnitsView", {
	...
	createOnlineRetUnitsSelFormView: function () {
		...
		oSerialNumbrTable.addColumn(new sap.ui.table.Column({
			...
			template: new sap.ui.commons.CheckBox().bindProperty("checked", "checked").bindProperty("name", "Sernr").bindProperty("checked",
				"isChecked"),
			width: "75px",
			//hAlign: "Center",
			resizable: false
		...
		// Textfields
		var oTxtCustomer = new sap.ui.commons.TextView("idValCustomer", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oTxtContract = new sap.ui.commons.TextView("idValContractNo", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oTxtUnitType = new sap.ui.commons.TextView("idValUnitType", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oTxtCountry = new sap.ui.commons.TextView("idValCountry", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oTxtCity = new sap.ui.commons.TextView("idValCity", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oTxtDepot = new sap.ui.commons.TextView("idValDepot", {
			layoutData: new sap.ui.layout.GridData({
				span: "L8 M3 S4",
				linebreak: false,
				margin: false
		...
		var oLabelContractNo = new sap.ui.commons.Label({
			text: "Contract No.: ",
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M3 S4",
				linebreak: false,
		...
		var oLabelDepot = new sap.ui.commons.Label({
			text: "Depot: ",
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M3 S4",
				linebreak: false,
		...
		var oLabelUnitNumbrTbltitle = new sap.ui.commons.Label({
			text: "Please select the units to Return by checking the required checkboxes",
			wrapping: true
	...
	bindUnitNumbers: function () {
		...
		oModelReturnsSelUnits.setData({
			modelData: aUnitNumbersOR
		});
