...
sap.ui.model.json.JSONModel.extend("FixPartialRepairEstimateShow", {
	...
	createFPUREShowFrm: function () {
		...
		//FIRST ROW
		var olblEstmtTypeFPURES = new sap.ui.commons.Label({
			text: "Estimate Type",
		...
		var otxtVwEstmtTypeFPURES = new sap.ui.commons.TextField({
			enabled: false,
		...
		var olblSerialNoFPURES = new sap.ui.commons.Label({
			text: "Serial Number",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwSerialNoFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblSendAddressFPURES = new sap.ui.commons.Label({
			text: "Sender Address",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwSendAddressFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		//SECOND ROW
		var olblEstmtNoFPURES = new sap.ui.commons.Label({
		...
		var otxtVwEstmtNoFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblCurrencyCodeFPURES = new sap.ui.commons.Label({
			text: "Currency Code",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwCurrencyCodeFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblMoveInDateFPURES = new sap.ui.commons.Label({
			text: "Movement In Date",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
				margin: true
		...
		var otxtVwMoveInDateFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		//THIRD ROW
		var olblSaleGradeFPURES = new sap.ui.commons.Label({
			text: "Sale Grade",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwSaleGradeFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblUnitPartCodeFPURES = new sap.ui.commons.Label({
			text: "Unit Part Code",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwUnitPartCodeFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblWorkCreatedDateFPURES = new sap.ui.commons.Label({
			text: "Work Created Date",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
				margin: true
		...
		var otxtVwWorkCreatedDateFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		//FORTH ROW
		var olblCntnrStrCompleteFPURES = new sap.ui.commons.Label({
			text: "Container Structure Complete",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
				margin: true
		...
		var olblMultiPartCntnrFPURES = new sap.ui.commons.Label({
			text: "Multi Part Container",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
				margin: true
		...
		var olblAssetNumberFPURES = new sap.ui.commons.Label({
			text: "Asset Number",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwAssetNumberFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		//FIFTH ROW
		var olblCompanyCodeFPURES = new sap.ui.commons.Label({
			text: "Company Code",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwCompanyCodeFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblEquipmentNoFPURES = new sap.ui.commons.Label({
		...
		var otxtVwEquipmentNoFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblFuncLocFPURES = new sap.ui.commons.Label({
		...
		var otxtVwFuncLocFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		//SIXTH ROW
		var olblMaterialTypeFPURES = new sap.ui.commons.Label({
			text: "Material Type",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwMaterialTypeFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblPlannerGroupFPURES = new sap.ui.commons.Label({
			text: "Planner Group",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwPlannerGroupFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
		...
		var olblRepairDecMsgNameFPURES = new sap.ui.commons.Label({
			text: "Repair Decision Msg Name",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
				margin: true
		...
		oComboRepairDecMsgNameFPURES.addItem(new sap.ui.core.ListItem({
			text: '',
			key: ''
		}));
		oComboRepairDecMsgNameFPURES.addItem(new sap.ui.core.ListItem({
		...
		var olblWrkCntrFPURES = new sap.ui.commons.Label({
			text: "Work Center",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M4 S12",
				linebreak: false,
		...
		var otxtVwWrkCntrFPURES = new sap.ui.commons.TextField({
			enabled: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M8 S12"
			})
				...
				new sap.ui.layout.form.FormContainer({
					...
					formElements: [
						...
						new sap.ui.layout.form.FormElement({ //.addStyleClass("marginTopBot30")
							fields: [new sap.ui.commons.HorizontalDivider("idHzntlDvdrFrstFPURES", {
								width: "100%",
								type: "Area",
								height: "Medium"
						...
						new sap.ui.layout.form.FormElement({
							fields: [new sap.ui.commons.Label("idLblRepHdrFPU", {
								text: "Repair Header",
								layoutData: new sap.ui.layout.GridData({
									span: "L12 M12 S12"
								}),
						...
						new sap.ui.layout.form.FormElement({
							fields: [olblEstmtTypeFPURES, otxtVwEstmtTypeFPURES, olblSerialNoFPURES, otxtVwSerialNoFPURES, olblSendAddressFPURES,
								otxtVwSendAddressFPURES
							]
						}),
						new sap.ui.layout.form.FormElement({
							fields: [olblEstmtNoFPURES, otxtVwEstmtNoFPURES, olblCurrencyCodeFPURES, otxtVwCurrencyCodeFPURES, olblMoveInDateFPURES,
								otxtVwMoveInDateFPURES
							]
						}),
						new sap.ui.layout.form.FormElement({
							fields: [olblSaleGradeFPURES, otxtVwSaleGradeFPURES, olblUnitPartCodeFPURES, otxtVwUnitPartCodeFPURES,
								olblWorkCreatedDateFPURES, otxtVwWorkCreatedDateFPURES
							]
						}),
						new sap.ui.layout.form.FormElement({
							fields: [olblCntnrStrCompleteFPURES, oChkBxCntnrStrCompleteFPURES, olblMultiPartCntnrFPURES, oChkBxMultiPartCntnrFPURES,
								olblAssetNumberFPURES, otxtVwAssetNumberFPURES
							]
						}),
						new sap.ui.layout.form.FormElement({
							fields: [olblCompanyCodeFPURES, otxtVwCompanyCodeFPURES, olblEquipmentNoFPURES, otxtVwEquipmentNoFPURES, olblFuncLocFPURES,
								otxtVwFuncLocFPURES
							]
						}),

						new sap.ui.layout.form.FormElement({
							fields: [olblMaterialTypeFPURES, otxtVwMaterialTypeFPURES, olblPlannerGroupFPURES, otxtVwPlannerGroupFPURES,
								olblRepairDecMsgNameFPURES, oComboRepairDecMsgNameFPURES
							]
						}),
						new sap.ui.layout.form.FormElement({
						...
						new sap.ui.layout.form.FormElement({
							fields: [new sap.ui.commons.HorizontalDivider({
								width: "100%",
								type: "Area",
								height: "Medium"
	...
	createLineItemTable: function () {
		var olblhdrTblFPURES = new sap.ui.commons.Label({
			text: "Repair Lines",
			layoutData: new sap.ui.layout.GridData({
				span: "L12 M12 S12"
			}),
