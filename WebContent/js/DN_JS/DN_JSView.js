...
sap.ui.model.json.JSONModel.extend("DN_JSview", {
	...
	createDNJSSearch: function (oController) {
		...
		var labDNJSRef1 = new sap.ui.commons.Label({
			text: "DN / JS Reference:",
			wrapping: true
		});
		var labDNJSRef2 = new sap.ui.commons.Label({
			text: "1 per line, 25 max",
			wrapping: true
		}).addStyleClass("font10");
		var labDNJSRef3 = new sap.ui.commons.Label({
		...
		var refFlex = new sap.m.FlexBox({
			items: [labDNJSRef1, labDNJSRef2, labDNJSRef3],
			direction: "Column",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M3 S4",
				linebreak: true,
	...
	validateReturnUnitNos: function (jsonUnit) {
		...
		var msg =
			"The following Unit Numbers do not match the specified Unit Type(s). \nPlease recheck and update the values before retrying.\n";
