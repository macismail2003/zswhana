...
sap.ui.model.json.JSONModel.extend("custReportUnitsOffHireView", {
	...
	createCustReportUnitsOffHire: function () {
		...
		// Labels
		var oLabelCustomerID = new sap.ui.commons.Label({
			text: "Customer ID:",
			required: false,
		...
		//MAC11122017_3+
		var oLabelLeaseType = new sap.ui.commons.Label({
			text: "Lease Type:",
			required: false,
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M4 S6",
		...
		var oLabelLeaseNumber = new sap.ui.commons.Label({
			text: "Lease Number:",
			required: true,
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M4 S6",
		...
		var oLabelOffHireDate = new sap.ui.commons.Label({
			text: "Off-Hire Date:",
			required: true,
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M4 S6",
		...
		var oLabelOffHireLocation = new sap.ui.commons.Label({
		...
		var oLabelUnitDescription = new sap.ui.commons.Label({
			text: "Unit Type:",
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M4 S6",
				linebreak: true,
		...
		var oLabelRANumber = new sap.ui.commons.Label({
			text: "RA Number:",
			layoutData: new sap.ui.layout.GridData({
				span: "L3 M4 S6",
				linebreak: true,
		...
		var oLabelFrom = new sap.ui.commons.Label({
			...
			wrapping: true
		}).addStyleClass("marginTop10 marginRight5");
		...
		var oLabelMandatory = new sap.ui.commons.Label({
			text: "Either of the fields required",
			required: true,
		...
		var oLabelLeaseType = new sap.ui.commons.Label({
			text: "- Enter Lease Type to enable Lease Number field",
			wrapping: true
		}).addStyleClass("marginTop10");
		...
		var oLabelSpaceForDate = new sap.ui.commons.Label({
			text: "",
			layoutData: new sap.ui.layout.GridData({
				span: "L2 M3 S3",
				linebreak: false,
		...
		var oLabelSpaceCRUOH = new sap.ui.commons.Label({
			text: " ",
			width: "8px",
			wrapping: true
		});
	...
	getUnitsOffHireReportCRUOH: function () {
		...
		var urlToCallCRUOH = serviceUrl + "/Units_Offhire_CR?$filter=ICustomer eq '" + customerID + "' and IFromOffhireDate eq '" +
			offHireDateFrom + "' and IToOffhireDate eq '" + offHireDateTo + "' and ICity eq '" + offHireLocationString + "' and ICity1 eq '" +
			offHireLocationString1 + "' and IUnitType eq '" + unitDescriptionString + "' and IRaNo eq '" + raNumberString + "' and IExtra1 eq '" +
			arrleaseNoString + "' and IExtra2 eq ' '"; //MAC11122017_3+ included arrleaseNo
	...
	createUnitsOffHireReportTblCRUOH: function () {
		...
		var oLabelTitle = new sap.ui.commons.Label({
			...
			wrapping: true
		}).addStyleClass("marginTop10 font15Bold");
	...
	updateUnitsOffHireReportCRUOH: function () {
		...
		oModelUnitsOffHireReportCRUOH.setData({
			modelData: arrUnitsOffHireReport
		});
	...
	updateErrorRAsTableReportCRUOH: function () {
		...
		oModelErrorRAsReportCRUOH.setData({
			modelData: arrErrorRAsReport
		});
