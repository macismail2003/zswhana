...
sap.ui.jsview("view.CustOutReturnDtlReportVw", {
	...
	createContent: function (oController) {
		var oVbxCORetDReport = new sap.m.VBox("idVbxCORetDReport", {
			width: "99%"
		});

		var oBckCORetDReport = new sap.m.Link("idBckCORetDReport", {
			text: " < Back",
			width: "50px",
			wrapping: true,
		...
		var olblHdrCORetDReport = new sap.ui.commons.Label("idlblHdrTblCORetDtlReport", {
			wrapping: true
		...
		oVbxCORetDReport.addItem(new sap.ui.commons.TextView({
			text: ' '
		}));
